...
import { item as MenuItem } from "../../hooks/Fetchinfo";
...
export const NewOrderPage = ({
  ...
  const HandleOrder = async () => {
    ...
    try {
      await onPlaceOrder({ tableId, items: selectedItems });
    } catch (e) {
        ...
        <div className="w-full lg:w-1/3">
          <div className="sticky top-24 bg-white rounded-xl shadow-lg p-6">
            ...
            <div>
              ...
              <select
                id="table-select"
                className="w-full p-2.5 text-slate-900 bg-slate-50 border border-slate-300 rounded-lg"
            ...
            <div className="mt-6 space-y-3">
              <PlaceOrder
                ...
                disabled={
                  isPlacingOrder || selectedItems.length === 0 || tableId === 0
                }
              />
              <ClearOrder
