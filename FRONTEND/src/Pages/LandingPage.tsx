        ...
        <div>
            <div className="bg-[#fcebfa] h-screen bg-cover bg-center ">
                ...
                <div className="flex justify-center items-center z-50 opacity-100">
                    <div className="w-11/12 mt-[100px] flex justify-center gap-2">
                        ...
                        <div className="w-2/3 flex justify-center items-center rounded-2xl shadow-lg bg-[#f9e4f7]">
                            <div className="flex flex-col items-center md:items-start text-center md:text-left">
                                <h1 className="text-4xl md:text-5xl font-bold text-blue-600 mb-4">Welcome to <span className="text-6xl md:text-7xl block mt-2">DELISH</span></h1>
                                <p className="text-lg text-gray-700 mb-6">Order Smarter, Faster, and Easier!</p>
                                <p className="text-gray-600 mb-8 max-w-md">Manage food orders, update menus, and streamline your restaurant operations effortlessly with our intuitive platform.</p>
